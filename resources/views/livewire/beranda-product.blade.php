<div
    ...
    <div class="mb-5 flex justify-center">
        <div class="border border-gray-300 min-w-1/2 rounded-md relative dark:border-gray-700">
                ...
                <form wire:submit.prevent='handleSaveHeadline' class="p-4">
                    <div class="mb-2">
                        <input type="text" id="productHeadlineTitle" wire:model='headlineTitle'
                            class="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 text-sm rounded-md focus:outline-gray-200 block w-full p-2.5"
                            placeholder="Judul">
                    </div>
                    <div class="mb-2">
                        <textarea id="productHeadlineSubtitle" rows="2" wire:model='headlineSubtitle'
                            class="block p-2.5 w-full text-sm text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-700 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-gray-400"
            ...
            @else
                <div class="p-8 flex flex-col justify-center items-center text-center">
                    ...
                    <button wire:click='handleOpenHeadlineForm' type="button"
                        class="absolute top-1 right-1 px-3 py-1.5 group border border-gray-700 hover:bg-gray-600 text-gray-600 dark:text-gray-300 hover:text-white text-xs rounded-sm">
        ...
        <form wire:submit.prevent='handleSaveContent'>
            ...
            <div class="p-4">
                <div class="flex space-x-5">
                    <div
                        class="w-[35%] space-y-4 bg-gray-50 dark:bg-gray-700 p-4 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700 hover:border-secondary-green transition-colors duration-300">
                    ...
                    <div class="w-[65%]">
                        <div class="mb-4">
                            ...
                            <input type="text" id="productTitle" wire:model='productTitle'
                                class="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 text-sm rounded-md focus:outline-gray-400 block w-full p-2.5"
                                placeholder="Judul">
                            @error('productTitle')
    ...
    <div class="grid grid-cols-3 gap-3">
        ...
        @foreach ($sections as $section)
            <div class="w-full h-fit border border-gray-300 dark:border-gray-700 rounded-md relative">

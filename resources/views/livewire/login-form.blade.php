<div
    ...
    <div class="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        <div class="px-6 py-8">
            ...
            <form wire:submit.prevent="handleLogin" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input wire:model="email" id="email" type="email"
                            class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-3 py-3 border-gray-300 rounded-md"

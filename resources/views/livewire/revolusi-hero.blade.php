    ...
    <div wire:show='isShowForm' wire:cloak wire:transition
        ...
        <form wire:submit.prevent="handleSave">
            ...
            <div class="p-4 space-y-6">
                <div
                    class="w-full space-y-4 bg-gray-50 p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-secondary-green transition-colors duration-300">
                    <div class="relative group">
                        ...
                        @else
                            <div
                                class="w-full h-[600px] rounded-lg shadow-md bg-gray-200 flex justify-center items-center">
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4">
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Deksripsi <span
                                class="text-sm text-red-500">*</span></label>

<div
    ...
    <div class="mt-2 grid grid-cols-2 gap-3">
        <div class="p-8 border border-gray-300 dark:border-gray-700 rounded-lg shadow-md bg-white dark:bg-[#252525]">
            <div class="space-y-5 relative">
                <div class="flex items-center gap-3">
                    <div class="w-2 h-10 bg-secondary-green rounded-full"></div>
                    <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-200">Visi</h2>
                </div>
                @if ($formType !== 'visi')
                    <button type="button" wire:click='handleOpenForm("visi")'
                        class="absolute top-0 right-0 px-3 py-1.5 group border border-gray-600 hover:bg-gray-600 text-gray-600 dark:text-gray-300 hover:text-white text-sm rounded-sm inline-flex items-center">
                ...
                @endif
                <p class="text-base text-gray-600 dark:text-gray-400 leading-relaxed pl-5">
                    {{ '"' . $visiData->content . '"' }}
                </p>
            </div>
        </div>
        <div class="p-8 border border-gray-300 dark:border-gray-700 rounded-lg shadow-md bg-white dark:bg-[#252525]">
            <div class="space-y-5 relative">
                <div class="flex items-center gap-3">
                    <div class="w-2 h-10 bg-secondary-green rounded-full"></div>
                    <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-200">Misi</h2>
                </div>
                @if ($formType !== 'misi')
                ...
                @endif
                <ul class="space-y-2 text-base text-gray-600 dark:text-gray-400 pl-6">

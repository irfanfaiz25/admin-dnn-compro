            ...
            @else
                <div class="p-8 flex flex-col justify-center items-center text-center">
                    ...
                    <button wire:click='handleOpenHeadlineForm' type="button"
                        class="absolute top-1 right-1 px-3 py-1.5 group border border-gray-600 hover:bg-gray-600 text-gray-600 hover:text-white text-xs rounded-sm inline-flex items-center">
    ...
    @if (!$isShowContentForm)
        <div class="flex justify-end">
            <button type="button" wire:click='handleOpenContentForm'
                class="mb-2 px-3 py-1.5 group border border-gray-600 hover:bg-gray-600 text-gray-600 hover:text-white text-xs rounded-sm inline-flex items-center">
